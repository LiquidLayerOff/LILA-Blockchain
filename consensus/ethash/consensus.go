...
var (
	FrontierBlockReward           = big.NewInt(5e+17) // Block reward in wei for successfully mining a block
	ByzantiumBlockReward          = big.NewInt(5e+17) // Block reward in wei for successfully mining a block upward from Byzantium
	ConstantinopleBlockReward     = big.NewInt(5e+17) // Block reward in wei for successfully mining a block upward from Constantinople
